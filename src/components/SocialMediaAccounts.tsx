    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
                <input className={`input w-full input-sm `} placeholder="Search accounts..."
                    value={search}
...

                {
                    loading ?
                        ...
                        filteredAccounts.length > 0 && filteredAccounts.map((i) => (
                            <div className="flex  items-center gap-4  border p-4 cursor-pointer rounded-md justify-between" key={i._id} >
                                <div className="flex gap-2 items-center shrink-0">
                                    <img src={i.avatar_url} className="size-10 rounded-full shrink-0 " />
